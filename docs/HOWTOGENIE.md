...
| **APIs & external** | |
| `COMPETITOR_RSS_FEEDS`, `RAPIDAPI_REDDIT_*`, `RAPIDAPI_ATP_*`, `REDDIT_CACHE_TTL_DAYS`, `ATP_CACHE_TTL_DAYS` | Competitor and API config |
| **System** | |
| `TIMEZONE`, `YOUR_N8N_URL`, `PERSONA` | Timezone, n8n URL, LLM persona |
