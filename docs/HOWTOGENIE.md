...
| *Audio Log tab column contract*                                                                                                                                                                                                                                                                                                  | One row per language. Columns: Date, Language, Podcast Title, Duration, File Path, Blog URL, Voice Provider, Status. Tab name from `AUDIO_LOG_TAB`. |
| **System**                                                                                                                                                                                                                                                                                                                        |                                   |
